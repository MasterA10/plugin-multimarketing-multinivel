        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-zinc-800/30">
                <?php if ( ! empty( $users ) ) : foreach ( $users as $u ) : 
                    $role = in_array( 'educadora', (array) $u->roles ) ? 'Educadora (40%)' : 'Autoridade (30%)';
                    $role_class = in_array( 'educadora', (array) $u->roles ) ? 'text-gold-500 bg-gold-500/10 border-gold-500/20' : 'text-zinc-400 bg-white/5 border-white/10';
