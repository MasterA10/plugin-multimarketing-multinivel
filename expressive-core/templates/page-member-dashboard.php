                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="glass p-10 rounded-[40px] border border-white/10 flex flex-col justify-between">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <?php if ($is_active_real): ?>
                                <a href="<?php echo home_url('/cancelar-assinatura/'); ?>" class="w-full py-4 text-zinc-600 hover:text-red-500 text-[9px] font-bold uppercase tracking-[0.2em] text-center transition-all cursor-pointer">Desejo Cancelar minha Assinatura</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
